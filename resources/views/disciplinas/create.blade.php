...
@section('content')
    <form action="{{ route('disciplinas.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="descricao" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('descricao') }}">
        </div>
